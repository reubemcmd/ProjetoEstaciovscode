      ...
      <View style={estilos.fundo}>
        <Image source={require('../Imagens/estacioTransparente.png' )} style={estilos.logo}></Image>
            ...
            <TouchableOpacity 
              ...
              activeOpacity={0.5}>
              <View>
                <Text style={estilos.bottondata}>SEM4- 23 a 29/04/23</Text>
              </View>
            </TouchableOpacity>
            ...
            <View style={estilos.item_check}>
              ...
              placeholder={'Gestão Realizar Reuniões GDO'} ></TextInput>
            </View>
            
            <View style={estilos.item_check}>
              <TextInput style={estilos.inputamanhoplace} 
              placeholder={'Gestão Realizar Reuniões GDA'} ></TextInput>

            </View>

            <View style={estilos.item_check}>
              <TextInput style={estilos.inputamanhoplace} 
              placeholder={'Engajamento Realizar tratamento'} ></TextInput>
